...
('Akira Kurosawa', 'Akira Kurosawa (黒澤 明) was a Japanese filmmaker and painter who directed thirty films in a career spanning over five decades. He is widely regarded as one of the greatest and most influential filmmakers in the history of cinema.', TO_DATE('1910-03-23', 'YYYY-MM-DD')),
('Anthony Hopkins', 'Sir Philip Anthony Hopkins CBE (born December 31, 1937) is a Welsh actor, film director, and film producer.', TO_DATE('1937-12-31', 'YYYY-MM-DD')),
('Eddie Murphy', 'Edward "Eddie" Regan Murphy (born April 3, 1961) is an American actor, voice actor, film director, producer, comedian, and singer.', TO_DATE('1961-04-03', 'YYYY-MM-DD')),
('Fernanda Torres', 'Fernanda Pinheiro Torres (Rio de Janeiro, September 15, 1965), is a Brazilian actress, writer, columnist and screenwriter.', TO_DATE('1965-09-15', 'YYYY-MM-DD')),
('Florence Pugh', 'Florence Pugh (/pjuː/ PEW; born 3 January 1996) is an English actress.', TO_DATE('1996-01-03', 'YYYY-MM-DD')),
('Greta Gerwig', 'Greta Gerwig is an American actress, playwright, screenwriter, and director based in NY.', TO_DATE('1983-08-04', 'YYYY-MM-DD')),
('Harrison Ford', 'Legendary Hollywood Icon Harrison Ford was born on July 13, 1942 in Chicago, Illinois.', TO_DATE('1942-07-13', 'YYYY-MM-DD')),
('Idris Elba', 'Idris Elba (born September 6, 1972) is a British television, theatre, and film actor who has starred in both British and American productions.', TO_DATE('1972-09-06', 'YYYY-MM-DD')),
('John Williams', 'John Towner Williams (born February 8, 1932) is an American composer and conductor.', TO_DATE('1932-02-08', 'YYYY-MM-DD')),
('Julia Roberts', 'Julia Fiona Roberts (born October 28, 1967) is an American actress. ', TO_DATE('1967-10-28', 'YYYY-MM-DD')),
('Kleber Mendonça Filho', 'Kleber Mendonça Filho (born 1968) is a film director, screenwriter, producer, and critic, born in Recife, Pernambuco, Brazil.', TO_DATE('1968-11-22', 'YYYY-MM-DD')),
('Lázaro Ramos', 'Luís Lázaro Sacramento Ramos (born November 1, 1978) is a Brazilian actor, presenter, director, writer and voice actor.', TO_DATE('1978-10-01', 'YYYY-MM-DD')),
('Leonardo DiCaprio', 'Leonardo Wilhelm DiCaprio (born November 11, 1974) is an American actor and film producer.', TO_DATE('1974-11-11', 'YYYY-MM-DD')),
('Natalie Portman', 'Natalie Portman (born Neta-Lee Hershlag, June 9, 1981) is an actress with dual American and Israeli citizenship.', TO_DATE('1981-06-09', 'YYYY-MM-DD')),
('Robert DeNiro', 'Robert Anthony De Niro (born August 17, 1943) is an American actor and film producer.', TO_DATE('1943-08-17', 'YYYY-MM-DD')),
('Stanley Kubrick', 'Stanley Kubrick (July 26, 1928 – March 7, 1999) was an American film director, writer, producer, and photographer who lived in England during most of the last four decades of his career.', TO_DATE('1928-07-26', 'YYYY-MM-DD')),
('Viola Davis', 'Viola Davis (/vaɪˈoʊlə/ vy-OH-lə; born August 11, 1965) is an American actress and film producer.', TO_DATE('1965-08-11', 'YYYY-MM-DD')),
('Wagner Moura', 'Wagner Maniçoba de Moura (born June 27, 1976) is a Brazilian actor, director and musician.', TO_DATE('1976-06-27', 'YYYY-MM-DD')),
('Winona Ryder', 'Winona Laura Horowitz (born October 29, 1971), known professionally as Winona Ryder, is an American actress.', TO_DATE('1971-10-29', 'YYYY-MM-DD')),
('Zendaya', 'Zendaya Maree Stoermer Coleman (born September 1, 1996) is an American actress and singer.', TO_DATE('1996-09-01', 'YYYY-MM-DD'));
...
INSERT INTO Log_Compartilhado (id_obra, id_usuario_log, id_usuario_compartilhador, instante_log) VALUES
(2, 12, 10, '2022-04-12 14:29:58'),
(4, 9, 1, '26-08-2003 16:28:07'),
(4, 9, 9, '26-08-2003 18:33:16'),
(3, 7, 18, '2023-07-23 04:05:49'),
(9, 13, 10, '2024-06-06 14:22:14'),
(9, 10, 7, '2020-05-30 02:52:39'),
(4, 10, 4, '2023-05-27 12:50:34');